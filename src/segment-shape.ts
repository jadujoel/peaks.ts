...
function SegmentShape(segment, peaks, layer, view) {
	...
	this._segmentMarkerDragBoundFunc =
		this._segmentMarkerDragBoundFunc.bind(this);
...
SegmentShape.prototype._dragBoundFunc = (pos) => {
...
SegmentShape.prototype._onSegmentMarkerDragStart = function (
	segmentMarker,
	event,
) {
	this._setPreviousAndNextSegments();
...
SegmentShape.prototype._onSegmentMarkerDragMove = function (
	segmentMarker,
	event,
) {
...
SegmentShape.prototype._segmentStartMarkerDragMove = function (
	segmentMarker,
	event,
) {
...
SegmentShape.prototype._segmentEndMarkerDragMove = function (
	segmentMarker,
	event,
) {
	const width = this._view.getWidth();
...
SegmentShape.prototype._onSegmentMarkerDragEnd = function (
	segmentMarker,
	event,
) {
	this._nextSegment = null;
...
SegmentShape.prototype._segmentMarkerDragBoundFunc = (segmentMarker, pos) => {
